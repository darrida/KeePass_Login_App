...
'print1=MsgBox(DecryptPass(KP1_ENCRYPT_HASH))
...
Private Function DecryptFileExistOpen()
	...
	Set objFile = objFSO.OpenTextFile(DecryptFile, 1, ForReading) 'DecryptFileLoc + DecryptFile, 1, ForReading)
