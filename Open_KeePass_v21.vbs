...
KP1 = chr(34) + KP1_PATH + KP1_FILE + chr(34) 'CStr(KP1_PATH + KP1_FILE) 
'CStr(KP1)
MsgBox KP1
'wscript.Quit
...
Private Function main()
	...
	wscript.Sleep 1000
	wshshell.SendKeys "C:\KeePass-Modified\KeePass.exe " + chr(34) + KP1_PATH + KP1_FILE + chr(34)
	wshshell.SendKeys "{ENTER}"
	Call WaitForWindow("Open Database - " + KP1_FILE)
	Call Paste(DecryptPass(KP1_ENCRYPT_HASH))
	wshshell.SendKeys "{ENTER}"
	Call WaitForWindow(KP1_FILE + " - KeePass")
	
	wshshell.AppActivate("Administrator:")
	wscript.Sleep 100
	wshshell.SendKeys "C:\KeePass-Modified\KeePass.exe " + chr(34) + KP2_PATH + KP2_FILE + chr(34)
	wshshell.SendKeys "{ENTER}"
	Call WaitForWindow("Open Database - " + KEY2_FILE)
	Call Paste(DecryptPass(KP2_ENCRYPT_HASH))
	wshshell.SendKeys "{ENTER}"
	Call WaitForWindow(KP2_FILE + " - KeePass")
	
	wshshell.AppActivate("Administrator:")'
	wscript.Sleep 100
	wshshell.SendKeys "C:\KeePass-Modified\KeePass.exe " + chr(34) + KP3_PATH & KP3_FILE + chr(34) + " -preselect:" + chr(34) + KP3_KEY_PATH + KP3_KEY + chr(34)
	wshshell.SendKeys "{ENTER}"
	Call WaitForWindow("Open Database - " + KEY3_FILE)
	Call Paste(DecryptPass(KP3_ENCRYPT_HASH))
	wshshell.SendKeys "{ENTER}"
	Call WaitForWindow(KP3_FILE + " - KeePass")
End Function
