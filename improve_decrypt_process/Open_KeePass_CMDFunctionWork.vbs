Dim objFile, DecryptFile, DecryptFileLoc, CMD_processID, objCMD, oCMD
...
Private Function StartCMD()
	Set objCMD = wshshell.Exec("cmd.exe")
	Set oCMD = objCMD.stdIn
	WScript.Sleep 1000
	CMD_processID = objCMD.ProcessID
	wshshell.AppActivate CMD_processID
	Do Until wshshell.AppActivate CMD_processID
		If (count1 < 50) Then
			wscript.Sleep 100
			count1 = count1 + 1
		Else
